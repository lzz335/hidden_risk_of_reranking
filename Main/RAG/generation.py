...
client1 = OpenAI(
        base_url="xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx",
        api_key="xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
)

# Initialize OpenAI client for local models via Ollama
client2 = OpenAI(
    base_url="xxxxxxxxxxxxxxxxxxxxxxxxxxx",  # Ollama's OpenAI-compatible interface
    api_key="xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"  # Dummy key for local inference
)
    ...
    while True:  # Retry loop for API reliability
        ...
        try:
            ...
            if count == 5:
                ...
                # retry
                return get_one_answer(query, question_type, corpus, q_id, model_name)
