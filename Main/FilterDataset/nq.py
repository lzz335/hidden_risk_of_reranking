...
from RAG.rag_util import read_jsonl, write_dict_to_jsonl
...
save_name = "../dataset/simplified_nq-dev-all.jsonl"
dataset = read_jsonl("../v1.0-simplified_nq-dev-all.jsonl")
for item in tqdm(dataset):
    filter_item = simplify_nq_example(item)
    write_dict_to_jsonl(filter_item, save_name)
